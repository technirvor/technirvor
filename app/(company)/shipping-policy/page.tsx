...
export const metadata: Metadata = {
  ...
  description:
    "Tech Nirvor's Shipping Policy. Learn about delivery times, shipping costs, and delivery options across Bangladesh.",
  keywords: [
    "shipping policy",
    "delivery policy",
    "shipping costs",
    "delivery times",
    "tech nirvor shipping",
  ],
};
...
export default function ShippingPolicyPage() {
  ...
  const packagingInfo = [
    ...
    },
    {
      ...
      features: [
        "Electronics in anti-static bags",
        "Books in moisture-proof covers",
        "Clothing in protective sleeves",
      ],
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-green-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">শিপিং নীতি</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
            বাংলাদেশ জুড়ে দ্রুত, নির্ভরযোগ্য ডেলিভারি। আমাদের শিপিং অপশন এবং
            ডেলিভারি প্রক্রিয়া সম্পর্কে জানুন।
          </p>
            ...
            <Card className="mb-12">
              ...
              <CardContent className="space-y-4">
                <p className="text-lg text-gray-700 leading-relaxed">
                  আমরা বাংলাদেশ জুড়ে আপনার অর্ডার দ্রুত এবং নিরাপদে পৌঁছে দিতে
                  প্রতিশ্রুতিবদ্ধ। আমাদের শিপিং নেটওয়ার্ক সকল ৬৪টি জেলায়
                  বিস্তৃত এবং আপনার প্রয়োজন অনুযায়ী বিভিন্ন ডেলিভারি অপশন
                  রয়েছে।
                </p>
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <p className="text-gray-700 mb-6">
                  Track your order every step of the way with our real-time
                  tracking system. You'll receive SMS and email updates at each
                  stage.
                </p>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      ...
                      <span className="text-gray-700">
                        Valid phone number required for delivery coordination
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Complete and accurate delivery address must be provided
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Weather conditions may cause delays during monsoon
                        season
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        National holidays and strikes may affect delivery
                        schedules
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Exact amount should be ready for cash on delivery orders
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Delivery person will provide receipt upon payment
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Additional COD charges may apply for certain areas
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-gray-700">
                  Have questions about shipping or need to track your order? Our
                  shipping support team is here to help:
                </p>
                <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                  ...
                  <p>
                    <strong>Email:</strong> shipping@technirvor.com
                  </p>
                  <p>
                    <strong>Track Order:</strong> Visit our Track Order page
                  </p>
                  <p>
                    <strong>Support Hours:</strong> 9:00 AM - 10:00 PM (Daily)
                  </p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <p className="text-blue-800 font-medium">
                    <strong>Quick Tip:</strong> Save our tracking SMS for easy
                    order monitoring. You can also track your order anytime from
