...
export const metadata: Metadata = {
  ...
  description:
    "Tech Nirvor's Return and Refund Policy. Learn about our return process, eligibility criteria, and refund procedures.",
  keywords: [
    "return policy",
    "refund policy",
    "exchange policy",
  ...
  const returnTimeframes = [
    {
      ...
      days: "৭ দিন",
      condition: "অবিকৃত মূল প্যাকেজিং",
    },
    {
      category: "ফ্যাশন ও পোশাক",
      days: "১৪ দিন",
      condition: "ট্যাগ সহ অব্যবহৃত",
    },
    { category: "বই ও মিডিয়া", days: "৩০ দিন", condition: "অক্ষত অবস্থা" },
    { category: "ঘর ও বাগান", days: "১৪ দিন", condition: "অব্যবহৃত অবস্থা" },
    {
      category: "সৌন্দর্য ও ব্যক্তিগত যত্ন",
      days: "৭ দিন",
      condition: "অবিকৃত ও সিল করা",
    },
    {
      category: "খেলাধুলা ও আউটডোর",
      days: "১৪ দিন",
      condition: "প্যাকেজিং সহ অব্যবহৃত",
    },
  ];
  ...
  const returnSteps = [
    {
      ...
      description:
        "Call us or send an email with your order number and reason for return.",
      icon: Phone,
    },
    {
      step: 2,
      ...
      description:
        "We'll provide a Return Authorization Number (RAN) and return instructions.",
      icon: CheckCircle,
    },
    {
      step: 3,
    ...
    },
    {
      ...
      description:
        "Send the package to us or schedule a pickup from your location.",
      icon: RotateCcw,
    },
    {
      step: 5,
      ...
      description:
        "We'll inspect the item and process your refund within 5-7 business days.",
      icon: CreditCard,
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">ফেরত নীতি</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
            আমরা চাই আপনি আপনার ক্রয়ে সম্পূর্ণ সন্তুষ্ট হন। আমাদের ঝামেলামুক্ত
            ফেরত প্রক্রিয়া সম্পর্কে জানুন।
          </p>
            ...
            <Card className="mb-12">
              ...
              <CardContent className="space-y-4">
                <p className="text-lg text-gray-700 leading-relaxed">
                  টেক নির্ভরে, গ্রাহক সন্তুষ্টি আমাদের প্রধান অগ্রাধিকার। আমরা
                  একটি ব্যাপক ফেরত নীতি অফার করি যাতে আপনি আপনার ক্রয়ে সম্পূর্ণ
                  খুশি হন। যদি আপনি কোনো কারণে সন্তুষ্ট না হন, আমরা এটি ঠিক করতে
                  সাহায্য করার জন্য এখানে আছি।
                </p>
                <div className="grid md:grid-cols-3 gap-6 mt-8">
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      পণ্যের ধরন অনুযায়ী ফেরতের সময় ভিন্ন
                    </p>
                  </div>
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      ত্রুটিপূর্ণ পণ্যের জন্য কোনো ফেরত শিপিং চার্জ নেই
                    </p>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      ৫-৭ কার্যদিবসের মধ্যে প্রক্রিয়া করা হয়
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Free return shipping and full refund
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        We'll arrange immediate pickup and replacement
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                    ...
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Priority processing for correct item delivery
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-700">
                        Standard return period applies
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></span>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mt-6">
                  <p className="text-blue-800 font-medium">
                    <strong>Pro Tip:</strong> Have your order number ready when
                    contacting us for faster service. You can find your order
                    number in your email confirmation or account dashboard.
                  </p>
                </div>
              </CardContent>
            </Card>
