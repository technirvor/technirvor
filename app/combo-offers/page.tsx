        ...
        <div className="bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg p-8 mb-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-2">
              Buy more, save more with our exclusive combo deals!
            </p>
            <p className="text-lg opacity-90">
              Get multiple products at unbeatable prices
            </p>
          </div>
        </div>
        ...
        {comboProducts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              Check back later for amazing combo deals!
            </p>
            <Link href="/products">
                ...
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get more products for less money with our carefully
                      curated combos
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600">
                      Everything you need in one package - no need to shop
                      separately
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600">
                      All combo products are hand-picked for quality and
                      compatibility
                    </p>
                  </div>
                </div>
