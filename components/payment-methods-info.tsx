    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          We support multiple payment methods to make your shopping experience
          convenient and secure. Choose the method that works best for you.
        </p>
      </div>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium mb-3 text-pink-700">
