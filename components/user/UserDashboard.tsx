...
import { UserDashboardData, RewardTransaction, UserReferral } from '@/lib/types/user';
...
export default function UserDashboard({ userId, onLogout }: UserDashboardProps) {
  ...
  const shareReferralCode = async () => {
    if (dashboardData?.user.referral_code && typeof navigator !== 'undefined' && 'share' in navigator) {
      try {
  ...
  const getTierIcon = (tier: string) => {
    switch (tier.toLowerCase()) {
      ...
      case 'silver': return <Trophy className="h-4 w-4 text-gray-500" />;
  ...
  const progressToNextTier = nextTier ? (rewards.total_points / nextTier.min_points) * 100 : 100;
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your account and track your rewards</p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{rewards.available_points}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{orderStats?.total_orders || 0}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{referrals?.length || 0}</p>
              </div>
          ...
          {nextTier && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  You need {nextTier.min_points - rewards.total_points} more points to reach {nextTier.tier_name} tier
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                {recent_transactions && recent_transactions.length > 0 ? (
                  recent_transactions.slice(0, 5).map((transaction: RewardTransaction) => (
                    <div key={transaction.id} className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <div className="text-right">
                        <p className={`font-medium ${
                          transaction.transaction_type === 'redeemed' ? 'text-red-600' : 'text-green-600'
                        }`}>
        ...
        <TabsContent value="rewards" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track your reward points and tier benefits</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 border rounded-lg">
                  <p className="text-2xl font-bold text-green-600">{rewards.total_earned}</p>
                  <p className="text-sm text-gray-600">Total Earned</p>
                </div>
                <div className="text-center p-4 border rounded-lg">
                  <p className="text-2xl font-bold text-red-600">{rewards.total_redeemed}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Tier: {currentTier.tier_name}</p>
                  <p className="text-sm font-medium mt-2">Discount: {currentTier.discount_percentage}%</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="referrals" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Invite friends and earn reward points</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Referral Code */}
              <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Share this code with friends. You'll both get bonus points when they make their first purchase!
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="text-center p-4 border rounded-lg">
                  <p className="text-2xl font-bold text-blue-600">{referrals?.length || 0}</p>
                  <p className="text-sm text-gray-600">Total Referrals</p>
                </div>
                <div className="text-center p-4 border rounded-lg">
                  <p className="text-2xl font-bold text-green-600">
                    {referrals?.filter((r: UserReferral) => r.status === 'completed').length || 0}
                  </p>
                  ...
                  <div className="space-y-2">
                    {referrals.map((referral: UserReferral) => (
                      <div key={referral.id} className="flex items-center justify-between p-3 border rounded-lg">
                        <div>
                          <p className="font-medium">User ID: {referral.referred_id}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium">{formatBangladeshiPhone(user.phone, 'international')}</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium">Member since {formatDate(user.created_at)}</p>
